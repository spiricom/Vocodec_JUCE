...
#endif
{
    presetNumber = 0;
    prevPresetNumber = 0;
    addParameter(vocoder_volume = new juce::AudioParameterFloat("vocoder_volume", "vocoder_volume", 0.0f, 1.0f, 0.4f));
    addParameter(vocoder_warp = new juce::AudioParameterFloat("vocoder_warp", "vocoder_warp", 0.0f, 1.0f, 0.5f));
    addParameter(vocoder_quality = new juce::AudioParameterFloat("vocoder_quality", "vocoder_quality", 0.0f, 1.0f, 0.85));
    addParameter(vocoder_sawToPulse = new juce::AudioParameterFloat("vocoder_sawToPulse", "vocoder_sawToPulse", 0.0f, 1.0f, 0.0f));
    addParameter(vocoder_noiseThreshold = new juce::AudioParameterFloat("vocoder_noiseThreshold", "vocoder_noiseThreshold", 0.0f, 1.0f, 0.2f));
    addParameter(vocoder_breath = new juce::AudioParameterFloat("vocoder_breath", "vocoder_breath", 0.0f, 1.0f, 0.02));
    ...
    addParameter(vocoderCh_volume = new juce::AudioParameterFloat("vocoderCh_volume", "vocoderCh_volume", 0.0f, 1.0f, 0.4f));
    addParameter(vocoderCh_warp = new juce::AudioParameterFloat("vocoderCh_warp", "vocoderCh_warp", 0.0f, 1.0f, 0.5f));
    addParameter(vocoderCh_quality = new juce::AudioParameterFloat("vocoderCh_quality", "vocoderCh_quality", 0.0f, 1.0f, 1.0f));
    addParameter(vocoderCh_bandWidth = new juce::AudioParameterFloat("vocoderCh_bandWidth", "vocoderCh_bandWidth", 0.0f, 1.0f, 0.5f));
    addParameter(vocoderCh_noiseThreshold = new juce::AudioParameterFloat("vocoderCh_noiseThreshold", "vocoderCh_noiseThreshold", 0.0f, 1.0f, 0.2f));
    addParameter(vocoderCh_sawToPulse = new juce::AudioParameterFloat("vocoderCh_sawToPulse", "vocoderCh_sawToPulse", 0.0f, 1.0f, 0.0f));
    ...
    addParameter(vocoderCh_breath = new juce::AudioParameterFloat("vocoderCh_breath", "vocoderCh_breath", 0.0f, 1.0f, 0.0f));
    addParameter(vocoderCh_speed = new juce::AudioParameterFloat("vocoderCh_speed", "vocoderCh_speed", 0.0f, 1.0f, 0.66f));
    ...
    addParameter(vocoderCh_stereo = new juce::AudioParameterFloat("vocoderCh_stereo", "vocoderCh_stereo", 0.0f, 1.0f, 0.0f));
    addParameter(vocoderCh_barkPull = new juce::AudioParameterFloat("vocoderCh_barkPull", "vocoderCh_barkPull", 0.0f, 1.0f, 0.0f));
    ...
    addParameter(pitchShift_f_Amt = new juce::AudioParameterFloat("pitchShift_f_Amt", "pitchShift_f_Amt", 0.0f, 1.0f, 0.0f));
    ...
    addParameter(pitchShift_offset = new juce::AudioParameterFloat("pitchShift_offset", "pitchShift_offset", 0.0f, 1.0f, 0.25f));
    addParameter(autotuneMono_pickiness = new juce::AudioParameterFloat("autotuneMono_pickiness", "autotuneMono_pickiness", 0.0f, 1.0f, 0.0f));
    addParameter(autotuneMono_amount = new juce::AudioParameterFloat("autotuneMono_amount", "autotuneMono_amount", 0.0f, 1.0f, 1.0f));
    addParameter(autotuneMono_speed = new juce::AudioParameterFloat("autotuneMono_speed", "autotuneMono_speed", 0.0f, 1.0f, 0.5f));
    addParameter(autotuneMono_leapallow = new juce::AudioParameterFloat("autotuneMono_leapallow", "autotuneMono_leapallow", 0.0f, 1.0f, 1.0f));
    addParameter(autotuneMono_hysteresis = new juce::AudioParameterFloat("autotuneMono_hysteresis", "autotuneMono_hysteresis", 0.0f, 1.0f, 0.25f));
    addParameter(autotunePoly_pickiness = new juce::AudioParameterFloat("autotunePoly_pickiness", "autotunePoly_pickiness", 0.0f, 1.0f, 1.0f));
    addParameter(samplerButtonPress_start = new juce::AudioParameterFloat("samplerButtonPress_start", "samplerButtonPress_start", 0.0f, 1.0f, 0.0f));
    addParameter(samplerButtonPress_length = new juce::AudioParameterFloat("samplerButtonPress_length", "samplerButtonPress_length", 0.0f, 1.0f, 1.0f));
    addParameter(samplerButtonPress_speed = new juce::AudioParameterFloat("samplerButtonPress_speed", "samplerButtonPress_speed", 0.0f, 1.0f, 0.75f));
    ...
    addParameter(samplerButtonPress_crossfade = new juce::AudioParameterFloat("samplerButtonPress_crossfade", "samplerButtonPress_crossfade", 0.0f, 1.0f, 0.4f));
    addParameter(samplerKeyboard_start = new juce::AudioParameterFloat("samplerKeyboard_start", "samplerKeyboard_start", 0.0f, 1.0f, 0.0f));
    addParameter(samplerKeyboard_length = new juce::AudioParameterFloat("samplerKeyboard_length", "samplerKeyboard_length", 0.0f, 1.0f, 1.0f));
    addParameter(samplerKeyboard_speed = new juce::AudioParameterFloat("samplerKeyboard_speed", "samplerKeyboard_speed", 0.0f, 1.0f, 0.75f));
    ...
    addParameter(samplerKeyboard_loopOn = new juce::AudioParameterFloat("samplerKeyboard_loopOn", "samplerKeyboard_loopOn", 0.0f, 1.0f, 0.0f));
    addParameter(samplerKeyboard_crossFade = new juce::AudioParameterFloat("samplerKeyboard_crossFade", "samplerKeyboard_crossFade", 0.0f, 1.0f, 0.4f));
    addParameter(samplerKeyboard_velo_Sens = new juce::AudioParameterFloat("samplerKeyboard_velo_Sens", "samplerKeyboard_velo_Sens", 0.0f, 1.0f, 0.0f));
    addParameter(samplerAutoGrab_threshold = new juce::AudioParameterFloat("samplerAutoGrab_threshold", "samplerAutoGrab_threshold", 0.0f, 1.0f, 0.95f));
    ...
    addParameter(samplerAutoGrab_speed = new juce::AudioParameterFloat("samplerAutoGrab_speed", "samplerAutoGrab_speed", 0.0f, 1.0f, 0.75f));
    addParameter(samplerAutoGrab_crossFade = new juce::AudioParameterFloat("samplerAutoGrab_crossFade", "samplerAutoGrab_crossFade", 0.0f, 1.0f, 0.25f));
    addParameter(samplerAutoGrab_lenRand = new juce::AudioParameterFloat("samplerAutoGrab_lenRand", "samplerAutoGrab_lenRand", 0.0f, 1.0f, 0.0f));
    addParameter(samplerAutoGrab_spdRand = new juce::AudioParameterFloat("samplerAutoGrab_spdRand", "samplerAutoGrab_spdRand", 0.0f, 1.0f, 0.0f));
    addParameter(distortion_preGain = new juce::AudioParameterFloat("distortion_preGain", "distortion_preGain", 0.0f, 1.0f, 0.25f));
    ...
    addParameter(distortion_postGain = new juce::AudioParameterFloat("distortion_postGain", "distortion_postGain", 0.0f, 1.0f, 0.25f));
    addParameter(wavefolder_gain = new juce::AudioParameterFloat("wavefolder_gain", "wavefolder_gain", 0.0f, 1.0f, 0.4f));
    ...
    addParameter(wavefolder_postGain = new juce::AudioParameterFloat("wavefolder_postGain", "wavefolder_postGain", 0.0f, 1.0f, 0.75f));
    addParameter(bitCrusher_quality = new juce::AudioParameterFloat("bitCrusher_quality", "bitCrusher_quality", 0.0f, 1.0f, 0.1f));
    addParameter(bitCrusher_sampRatio = new juce::AudioParameterFloat("bitCrusher_sampRatio", "bitCrusher_sampRatio", 0.0f, 1.0f, 0.5f));
    addParameter(bitCrusher_rounding = new juce::AudioParameterFloat("bitCrusher_rounding", "bitCrusher_rounding", 0.0f, 1.0f, 0.0f));
    addParameter(bitCrusher_operation = new juce::AudioParameterFloat("bitCrusher_operation", "bitCrusher_operation", 0.0f, 1.0f, 0.0f));
    addParameter(bitCrusher_postGain = new juce::AudioParameterFloat("bitCrusher_postGain", "bitCrusher_postGain", 0.0f, 1.0f, 0.5f));
    addParameter(bitCrusher_preGain = new juce::AudioParameterFloat("bitCrusher_preGain", "bitCrusher_preGain", 0.0f, 1.0f, 0.0f));
    addParameter(delay_delayL = new juce::AudioParameterFloat("delay_delayL", "delay_delayL", 0.0f, 1.0f, 0.25f));
    addParameter(delay_delayR = new juce::AudioParameterFloat("delay_delayR", "delay_delayR", 0.0f, 1.0f, 0.25f));
    addParameter(delay_highPass = new juce::AudioParameterFloat("delay_highPass", "delay_highPass", 0.0f, 1.0f, 0.0f));
    addParameter(delay_lowPass = new juce::AudioParameterFloat("delay_lowPass", "delay_lowPass", 0.0f, 1.0f, 1.0f));
    addParameter(delay_feedback = new juce::AudioParameterFloat("delay_feedback", "delay_feedback", 0.0f, 1.0f, 0.5f));
    addParameter(delay_postGain = new juce::AudioParameterFloat("delay_postGain", "delay_postGain", 0.0f, 1.0f, 1.0f));
    addParameter(delay_postGain1 = new juce::AudioParameterFloat("delay_postGain1", "delay_postGain1", 0.0f, 1.0f, 1.0f));
    addParameter(delay_postGain2 = new juce::AudioParameterFloat("delay_postGain2", "delay_postGain2", 0.0f, 1.0f, 1.0f));
    addParameter(delay_postGain3 = new juce::AudioParameterFloat("delay_postGain3", "delay_postGain3", 0.0f, 1.0f, 1.0f));
    ...
    addParameter(reverb2_size = new juce::AudioParameterFloat("reverb2_size", "reverb2_size", 0.0f, 1.0f, 0.2f));
    ...
    addParameter(livingString_freq1 = new juce::AudioParameterFloat("livingString_freq1", "livingString_freq1", 0.0f, 1.0f, 0.3f));
    addParameter(livingString_detune = new juce::AudioParameterFloat("livingString_detune", "livingString_detune", 0.0f, 1.0f, 0.1f));
    addParameter(livingString_decay = new juce::AudioParameterFloat("livingString_decay", "livingString_decay", 0.0f, 1.0f, 0.3f));
    addParameter(livingString_damping = new juce::AudioParameterFloat("livingString_damping", "livingString_damping", 0.0f, 1.0f, 0.9f));
    addParameter(livingString_pickPos = new juce::AudioParameterFloat("livingString_pickPos", "livingString_pickPos", 0.0f, 1.0f, 0.5f));
    addParameter(livingString_prepPos = new juce::AudioParameterFloat("livingString_prepPos", "livingString_prepPos", 0.0f, 1.0f, 0.25f));
    addParameter(livingString_prepForce = new juce::AudioParameterFloat("livingString_prepForce", "livingString_prepForce", 0.0f, 1.0f, 0.0f));
    addParameter(livingString_letRing = new juce::AudioParameterFloat("livingString_letRing", "livingString_letRing", 0.0f, 1.0f, 0.0f));
    addParameter(livingString_freq2 = new juce::AudioParameterFloat("livingString_freq2", "livingString_freq2", 0.0f, 1.0f, 0.8f));
    addParameter(livingString_freq3 = new juce::AudioParameterFloat("livingString_freq3", "livingString_freq3", 0.0f, 1.0f, 0.3f));
    addParameter(livingString_freq4 = new juce::AudioParameterFloat("livingString_freq4", "livingString_freq4", 0.0f, 1.0f, 0.3f));
    addParameter(livingString_freq5 = new juce::AudioParameterFloat("livingString_freq5", "livingString_freq5", 0.0f, 1.0f, 0.3f));
    addParameter(livingString_freq6 = new juce::AudioParameterFloat("livingString_freq6", "livingString_freq6", 0.0f, 1.0f, 0.3f));
    ...
    addParameter(livingStringSynth_decay = new juce::AudioParameterFloat("livingStringSynth_decay", "livingStringSynth_decay", 0.0f, 1.0f, .85f));
    addParameter(livingStringSynth_damping = new juce::AudioParameterFloat("livingStringSynth_damping", "livingStringSynth_damping", 0.0f, 1.0f, 1.0f));
    addParameter(livingStringSynth_pickPos = new juce::AudioParameterFloat("livingStringSynth_pickPos", "livingStringSynth_pickPos", 0.0f, 1.0f, 0.4f));
    addParameter(livingStringSynth_prepPos = new juce::AudioParameterFloat("livingStringSynth_prepPos", "livingStringSynth_prepPos", 0.0f, 1.0f, 0.25f));
    addParameter(livingStringSynth_prepForce = new juce::AudioParameterFloat("livingStringSynth_prepForce", "livingStringSynth_prepForce", 0.0f, 1.0f, 0.0f));
    addParameter(livingStringSynth_letRing = new juce::AudioParameterFloat("livingStringSynth_letRing", "livingStringSynth_letRing", 0.0f, 1.0f, 0.0f));
    addParameter(livingStringSynth_fBLevel = new juce::AudioParameterFloat("livingStringSynth_fBLevel", "livingStringSynth_fBLevel", 0.0f, 1.0f, 0.3f));
    addParameter(livingStringSynth_release = new juce::AudioParameterFloat("livingStringSynth_release", "livingStringSynth_release", 0.0f, 1.0f, 0.4f));
    ...
    addParameter(classicSynth_keyFollow = new juce::AudioParameterFloat("classicSynth_keyFollow", "classicSynth_keyFollow", 0.0f, 1.0f, 0.2f));
    addParameter(classicSynth_detune = new juce::AudioParameterFloat("classicSynth_detune", "classicSynth_detune", 0.0f, 1.0f, 0.0f));
    addParameter(classicSynth_filterQ = new juce::AudioParameterFloat("classicSynth_filterQ", "classicSynth_filterQ", 0.0f, 1.0f, 0.06f));
    addParameter(classicSynth_attack = new juce::AudioParameterFloat("classicSynth_attack", "classicSynth_attack", 0.0f, 1.0f, 0.9f));
    addParameter(classicSynth_decay = new juce::AudioParameterFloat("classicSynth_decay", "classicSynth_decay", 0.0f, 1.0f, 0.1f));
    addParameter(classicSynth_sustain = new juce::AudioParameterFloat("classicSynth_sustain", "classicSynth_sustain", 0.0f, 1.0f, 0.1f));
    addParameter(classicSynth_release = new juce::AudioParameterFloat("classicSynth_release", "classicSynth_release", 0.0f, 1.0f, 0.06));
    addParameter(classicSynth_leak = new juce::AudioParameterFloat("classicSynth_leak", "classicSynth_leak", 0.0f, 1.0f, 0.9f));
    addParameter(classicSynth_fAttack = new juce::AudioParameterFloat("classicSynth_fAttack", "classicSynth_fAttack", 0.0f, 1.0f, 0.1f));
    addParameter(classicSynth_fDecay = new juce::AudioParameterFloat("classicSynth_fDecay", "classicSynth_fDecay", 0.0f, 1.0f, 0.1f));
    addParameter(classicSynth_fSustain = new juce::AudioParameterFloat("classicSynth_fSustain", "classicSynth_fSustain", 0.0f, 1.0f, 0.0f));
    addParameter(classicSynth_fRelease = new juce::AudioParameterFloat("classicSynth_fRelease", "classicSynth_fRelease", 0.0f, 1.0f, 0.06f));
    addParameter(classicSynth_fLeak = new juce::AudioParameterFloat("classicSynth_fLeak", "classicSynth_fLeak", 0.0f, 1.0f, 0.9f));
    addParameter(classicSynth_fAmount = new juce::AudioParameterFloat("classicSynth_fAmount", "classicSynth_fAmount", 0.0f, 1.0f, 0.1f));
    addParameter(classicSynth_sawPulse = new juce::AudioParameterFloat("classicSynth_sawPulse", "classicSynth_sawPulse", 0.0f, 1.0f, 0.1f));
    addParameter(rhodes_brightness = new juce::AudioParameterFloat("rhodes_brightness", "rhodes_brightness", 0.0f, 1.0f, 0.25f));
    addParameter(rhodes_tremDepth = new juce::AudioParameterFloat("rhodes_tremDepth", "rhodes_tremDepth", 0.0f, 1.0f, 0.25f));
    addParameter(rhodes_tremRate = new juce::AudioParameterFloat("rhodes_tremRate", "rhodes_tremRate", 0.0f, 1.0f, 0.25f));
    addParameter(rhodes_drive = new juce::AudioParameterFloat("rhodes_drive", "rhodes_drive", 0.0f, 1.0f, 0.5f));
    addParameter(rhodes_panSpread = new juce::AudioParameterFloat("rhodes_panSpread", "rhodes_panSpread", 0.0f, 1.0f, 0.0f));
    addParameter(rhodes_attack = new juce::AudioParameterFloat("rhodes_attack", "rhodes_attack", 0.0f, 1.0f, 0.05f));
    addParameter(rhodes_decay = new juce::AudioParameterFloat("rhodes_decay", "rhodes_decay", 0.0f, 1.0f, 0.05f));
    addParameter(rhodes_sustain = new juce::AudioParameterFloat("rhodes_sustain", "rhodes_sustain", 0.0f, 1.0f, 0.9f));
    addParameter(rhodes_release = new juce::AudioParameterFloat("rhodes_release", "rhodes_release", 0.0f, 1.0f, 0.1007f));
    addParameter(rhodes_leak = new juce::AudioParameterFloat("rhodes_leak", "rhodes_leak", 0.0f, 1.0f, 0.5f));
    addParameter(rhodes_index1 = new juce::AudioParameterFloat("rhodes_index1", "rhodes_index1", 0.0f, 1.0f, 0.05f));
    addParameter(rhodes_index2 = new juce::AudioParameterFloat("rhodes_index2", "rhodes_index2", 0.0f, 1.0f, 0.05f));
    addParameter(rhodes_index3 = new juce::AudioParameterFloat("rhodes_index3", "rhodes_index3", 0.0f, 1.0f, 0.9f));
    addParameter(rhodes_index4 = new juce::AudioParameterFloat("rhodes_index4", "rhodes_index4", 0.0f, 1.0f, 0.1007f));
    addParameter(rhodes_index5 = new juce::AudioParameterFloat("rhodes_index5", "rhodes_index5", 0.0f, 1.0f, 0.5f));
    addParameter(rhodes_ratio1 = new juce::AudioParameterFloat("rhodes_ratio1", "rhodes_ratio1", 0.0f, 1.0f, 0.8f));
    addParameter(rhodes_ratio2 = new juce::AudioParameterFloat("rhodes_ratio2", "rhodes_ratio2", 0.0f, 1.0f, 0.6f));
    addParameter(rhodes_ratio3 = new juce::AudioParameterFloat("rhodes_ratio3", "rhodes_ratio3", 0.0f, 1.0f, 0.7f));
    ...
    addParameter(rhodes_feedback = new juce::AudioParameterFloat("rhodes_feedback", "rhodes_feedback", 0.0f, 1.0f, 0.0f));
    addParameter(rhodes_tuneSnap = new juce::AudioParameterFloat("rhodes_tuneSnap", "rhodes_tuneSnap", 0.0f, 1.0f, 0.00f));
    addParameter(rhodes_randDecay = new juce::AudioParameterFloat("rhodes_randDecay", "rhodes_randDecay", 0.0f, 1.0f, 0.00f));
    addParameter(rhodes_randSust = new juce::AudioParameterFloat("rhodes_randSust", "rhodes_randSust", 0.0f, 1.0f, 0.00f));
}
